...
/**
 * This solution is a difficult NM DP with CC cycle decomposition and what not.
 * Easier solution (new learning opportunity!! :) ) is follows.
 * If after NM moves, robot placements will converge. For each "equivelence class" take the node. If it's possible to be black take black.
 * Then answer is very easy after that. Very greedy, very propagationey, dang and binary lifting!!
 */
